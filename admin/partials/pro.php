<div class="wow-admin-col">	
	...
	<div class="wow-admin-col-6 right">
		<a href="https://wow-estore.com/item/wow-modal-windows-pro/" target="_blank" class="wow-btn">GET PRO VERSION</a>
	</div>
</div>
...
<div style="padding-left: 20px; padding-right:20px; float: left; font-family: Tahoma; width: 60%; font-size:18px;">
	...
	<ol>
		<li style="margin-bottom:15px;">Leave a 5 star rating and add a comment at the <a href="https://wordpress.org/support/plugin/mwp-modal-windows/reviews/" target="_blank" style="color: #43cb83;">plugin's wordpress.org page</a></li>
